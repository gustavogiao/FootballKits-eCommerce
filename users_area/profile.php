...
<div class="row">
    <div class="col-md-2">
        <ul class="navbar-nav bg-secondary text-center" style="height:100vh">
            ...
            <?php 
            $getUsers = "SELECT * FROM user_table WHERE userName = '".$_SESSION['userName']."'";
            $runGetUsers = mysqli_query($con, $getUsers);
            $row = mysqli_fetch_array($runGetUsers);
            $userImg = $row['user_image'];
            echo "<li class='nav-item'>
                <img src='./users_images/$userImg' class='profileImage my-5' alt=''>
            </li>"
            ?>
            <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link text-light" href="profile.php?editAccount">Edit Account</a>
            </li>
            <li class="nav-item">
            <a class="nav-link text-light" href="profile.php?myOrders">My Orders</a>
            </li>
            <li class="nav-item">
            <a class="nav-link text-light" href="profile.php?deleteAccount">Delete Account</a>
            </li>
            <li class="nav-item">
